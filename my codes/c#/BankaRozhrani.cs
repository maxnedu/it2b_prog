class Program
{
    static void Main()
    {
        ...
        int vyber;
        Banka banka = new Banka(10000, 2000, "password");
        if (banka.Autorizace("password") == true)
        {
            Console.WriteLine("Autorizace probehla uspesne!");
            while (pokracovat)
            {
                ...
                switch (vyber)
                {
                    ...
                    case 3:
                        ...
                        int vlozit =int.Parse(Console.ReadLine());
                        banka.Vlozit(vlozit);
                        break;
                    case 4:
